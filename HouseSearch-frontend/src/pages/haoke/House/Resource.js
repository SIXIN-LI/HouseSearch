...
import {runInContext as payType} from "lodash";
...
class Resource extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      title: '楼栋',
      render : (text, record, index) => {
        return record.buildingFloorNum + "栋"+record.buildingNum+"单 元"+record.buildingUnit+"号"
      }
    }, {
      title: '支付方式',
      render : (text, record, index) => {
    ...
    },
    {
      ...
      render: (text, record) => (
          <Fragment>
            <a onClick={() => this.handleUpdateModalVisible(true, record)}>查看</a> <Divider type="vertical" />
            <a href="">删除</a>
          </Fragment>
      ),
    },
