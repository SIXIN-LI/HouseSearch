...
import findRoute, {
  getUrlQuery,
} from '/Users/sixinli/Desktop/SideProjects/HouseSearch-frontend/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/sixinli/Desktop/SideProjects/HouseSearch-frontend',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
