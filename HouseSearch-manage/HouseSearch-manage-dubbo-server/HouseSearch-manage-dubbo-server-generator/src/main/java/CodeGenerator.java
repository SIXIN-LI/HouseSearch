...
public class CodeGenerator {
    ...
    public static void main(String[] args) { // 代码生成器
        ...
        gc.setAuthor("sixinli");
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig(); dsc.setUrl("jdbc:mysql://localhost:3306/haoke?useUnicode=true&characterEncoding=utf8&autoReconnect=true&allowMultiQueries=true");
        ...
        strategy.setSuperEntityClass("HouseSearch.dubbo.server.pojo.BasePojo");
