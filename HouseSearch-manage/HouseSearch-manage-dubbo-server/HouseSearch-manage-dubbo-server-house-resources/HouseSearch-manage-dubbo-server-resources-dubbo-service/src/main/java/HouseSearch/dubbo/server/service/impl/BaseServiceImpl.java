...
import HouseSearch.dubbo.server.pojo.BasePojo;
...
public abstract class BaseServiceImpl<T extends BasePojo> {
     ...
     * @return
     */
    public IPage<T> queryPageListByWhere(T record, Integer page, Integer rows) { // 获取分页数据
    ...
    /**
     * Retrieve data based on query conditions
     * */
    public IPage queryPageList(QueryWrapper<T> queryWrapper, int page, int pageSize) {
